...
export default function Page() {
  return (
    <m.page name="home"><div className="flex h-full">
            <m.slot name="sidebar" level={0} preserve={true}><Sidebar navigationItems={NAV_ITEMS} user={MOCK_USER} /></m.slot>
            <m.slot name="main-container" level={0}><div className="flex flex-col flex-1 min-w-0 overflow-hidden">
