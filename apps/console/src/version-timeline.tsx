  ...
  if (entries.length === 0) {
    return (
      <p className="rounded-xl bg-white/[0.04] p-6 text-sm text-white/50 ring-1 ring-white/10">
        No theme edits yet for this user. As they describe a vibe in the app&rsquo;s
        customization panel, every change lands here with the prompt that produced it.
      </p>
    );
  }
  return (
