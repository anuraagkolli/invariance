...
// reloads so the merged config flows into the live provider — active for new
// edits immediately, other sessions on their next request.
...
interface LockControlsProps {
  ...
  // m.slot section names the developer can pin (fed by the caller)
  sections: string[]
  onSave: (overlay: DesignConfig) => Promise<void>
}

export function LockControls({ overlay, baseLevels, currentAccent, sections: lockableSections, onSave }: LockControlsProps) {
