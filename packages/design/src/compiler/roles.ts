...
// The role vocabulary moved to @invariance/design-schema. Re-exported here for
// back-compat so existing './roles' imports keep resolving; the assignment
// logic below stays in core.
export { ROLE_TOKENS, COLOR_ROLE_TOKENS } from '@invariance/design-schema'
export type { RoleToken } from '@invariance/design-schema'
